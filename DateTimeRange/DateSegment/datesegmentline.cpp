...
DateSegmentLine::DateSegmentLine(QWidget *parent):QLineEdit(parent),
...
//                     "border-image: url(calend2.svg) 0 0 0 0;}");
    connect(openCalenderBtn,&QToolButton::clicked,
            this,&DateSegmentLine::signalOpenCalender);
}


void DateSegmentLine::slotDateTimeRangeChanged(QDateTime start, QDateTime end)
{
    QString timeStr;
